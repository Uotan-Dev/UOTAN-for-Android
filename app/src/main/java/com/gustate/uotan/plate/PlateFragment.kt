package com.gustate.uotan.plate
...
import com.gustate.uotan.parse.plate.PlateItem
import com.gustate.uotan.parse.plate.PlateParse
...
class PlateFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = PlateAdapter(mutableListOf())
    ...
    private fun onTabClicked(index: Int) {
        ...
        lifecycleScope.launch {
            ...
            recyclerView.adapter = PlateAdapter(newData.toMutableList())
    ...
    private fun loadInitialData() {
        lifecycleScope.launch {
            ...
            recyclerView.adapter = PlateAdapter(initialData.toMutableList())
